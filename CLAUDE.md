...
- **Sizes** follow the guidebook ladder but are set for reading: article body 18.5px, headline up to 3.6rem, card headline ~1.75rem, labels never below ~12px (`css/article.css`, journal block at the end of `css/brand.css`).
